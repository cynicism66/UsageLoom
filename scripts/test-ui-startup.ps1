...
foreach($scenario in $scenarios){
    ...
    if(!$Personalization -and !$CapacityDetails -and !($lines -match 'Claude history: scoped observations, independent date filter and disabled source boundaries passed')){throw 'Claude quota history check did not complete'}
